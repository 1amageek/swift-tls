...
/// at `C = TLSFoundationProvider` produces byte-for-byte the RFC 8448 Section 3
...
struct TLSKeyScheduleSeamDifferentialTests {
    ...
    func coreEarlySecretMatchesRFC() throws {
        var ks = TLSCryptoCore.TLSKeySchedule<TLSFoundationProvider>(cipherSuite: .tls_aes_128_gcm_sha256)
    ...
    func adapterMatchesCoreHandshake() throws {
        ...
        // Generic core path
        var core = TLSCryptoCore.TLSKeySchedule<TLSFoundationProvider>(cipherSuite: .tls_aes_128_gcm_sha256)
    ...
    func finishedVerifyDataMatches() throws {
        ...
        let core256 = TLSCryptoCore.TLSKeySchedule<TLSFoundationProvider>(cipherSuite: .tls_aes_128_gcm_sha256)
        ...
        let core384 = TLSCryptoCore.TLSKeySchedule<TLSFoundationProvider>(cipherSuite: .tls_aes_256_gcm_sha384)
    ...
    func transcriptHashMatches() throws {
        ...
        var core = TLSCryptoCore.TLSTranscriptHash<TLSFoundationProvider>(cipherSuite: .tls_aes_128_gcm_sha256)
    ...
    func emptyTranscriptHashMatches() {
        let core = TLSCryptoCore.TLSTranscriptHash<TLSFoundationProvider>(cipherSuite: .tls_aes_128_gcm_sha256)
