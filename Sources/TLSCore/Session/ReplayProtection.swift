...
///
/// The underlying transport may provide its own replay protection. TLS 0-RTT requires
...
public enum EarlyDataError: Error, Sendable {
    ...
    /// Invalid data in 0-RTT context
    case invalidDataIn0RTT(String)
