...
public struct HandshakeContext: Sendable {
    ...
    /// Cipher suites offered in ClientHello (for validation of ServerHello)
    public var offeredCipherSuites: [CipherSuite] = []
    ...
    /// Local transport parameters (optional, e.g., for QUIC)
    public var localTransportParameters: Data?

    /// Peer transport parameters (optional, e.g., for QUIC)
    ...
    public var clientVerificationKey: (any TLSVerificationKey)?
